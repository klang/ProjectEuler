...
(comment
  ...
  (= xxxxx (rem (* 54176 (f9s 500000001 800000000)) (expt 10 5))) 
  ;; (* (f9 1 500000000) (f9s 500000001 800000000)) = (f9s 1 80000000)
  (= res   (rem (* xxxxx (f9s 5000000001 8000000000)) (expt 10 5))) 
  ...
  (= 0     (f? 800000000)  (f? 4000000000)  (f? 20000000000)  (f? 100000000000) (f? 500000000000))
