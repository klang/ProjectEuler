...
(comment
  ...
  (= 84736 (f5 900000))
  (= 92576 (f5 6000000)) ;; (mod (f9 100000) (f9s 100000 200000) (f9s 1000000 1200000) (expt 10 5))
  (= 98656 (f5 7000000)) ;; (mod (* 12544 (f9s 1000000 1400000) ) (expt 10 5))
  (= 38144 
     (f5 8000000)        ;; (mod (* 12544 (f9s 1000000 1600000) ) (expt 10 5))
     ;(f5 40000000) 
     ;(f5 200000000) 
     ;(f5 1000000000)
     );? 
  (= 88096 (f5 9000000)) ;; (mod (* 12544 (f9s 1000000 1800000) ) (expt 10 5))
  (= 46112 (f5 80000000))
  ; (f5 400000000)
  ; (f5 2000000000)
  ; (f5 10000000000)
...
(comment
  ...
  (= ;;(f9s 1 100000000000)
   (rem (* 46112 ) (expt 10 5))) ; (f9s 1000000000 2000000000)
  (= ;;(f9s 1 1000000000000)
   ))
